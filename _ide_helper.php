 ...
 * Generated for Laravel 5.1.16 (LTS) on 2015-11-05.
 *
...
namespace {
    ...
    class BrowserDetect extends \hisorange\BrowserDetect\Facade\Parser{
        ...
        public static function getEmptyDataSchema(){
            return \hisorange\BrowserDetect\Parser::getEmptyDataSchema();
        }
         ...
         * @static 
         */
        public static function runTimeCacheExists($key){
            return \hisorange\BrowserDetect\Parser::runTimeCacheExists($key);
        }
         ...
         * @static 
         */
        public static function runTimeCacheSet($key, $value){
            \hisorange\BrowserDetect\Parser::runTimeCacheSet($key, $value);
        }
         ...
         * @static 
         */
        public static function runTimeCacheGet($key, $default = null){
            return \hisorange\BrowserDetect\Parser::runTimeCacheGet($key, $default);
        }
         ...
         * @static 
         */
        public static function runTimeCacheReset(){
            \hisorange\BrowserDetect\Parser::runTimeCacheReset();
        }
         ...
         * @static 
         */
        public static function objectConfigImport($cache){
            \hisorange\BrowserDetect\Parser::objectConfigImport($cache);
        }
         ...
         * @static 
         */
        public static function objectConfigExport(){
            return \hisorange\BrowserDetect\Parser::objectConfigExport();
        }
         ...
         * @static 
         */
        public static function objectConfigReset(){
            \hisorange\BrowserDetect\Parser::objectConfigReset();
        }
         ...
         * @static 
         */
        public static function pluginCollectionImport($plugins){
            \hisorange\BrowserDetect\Parser::pluginCollectionImport($plugins);
        }
         ...
         * @static 
         */
        public static function pluginCollectionExport(){
            return \hisorange\BrowserDetect\Parser::pluginCollectionExport();
        }
         ...
         * @static 
         */
        public static function pluginCollectionRegister($plugin, $config = array()){
            \hisorange\BrowserDetect\Parser::pluginCollectionRegister($plugin, $config);
        }
         ...
         * @static 
         */
        public static function pluginCollectionDeregister($plugin){
            \hisorange\BrowserDetect\Parser::pluginCollectionDeregister($plugin);
        }
